-- ============================================
-- SCRIPT COMPLETO: RESET E CRIAÇÃO DO BANCO
-- ============================================
-- Este script faz TUDO de uma vez:
-- 1. Dropa todas as tabelas
-- 2. Recria todas as tabelas corretamente
...
-- ============================================
-- PARTE 1: DROPAR TODAS AS TABELAS
-- ============================================
...
-- Tabela: devices (deve ser criada primeiro por causa das foreign keys)
...
-- Mensagem de sucesso
SELECT 'Banco de dados resetado e todas as tabelas criadas com sucesso!' AS status;
